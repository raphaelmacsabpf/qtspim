...
main:
	...
	bne $9,$0, DESVIO_OPC1_IF1
        ...
        sb $zero,4($15) 	#//O PRÓXIMO ELEMENTO DA LISTA É NULO QUE NESTE CASO É ZERO
	...
	beq $12, $zero, DESVIO_OPC1_IF2         #//SE O SLT DEU FALSO ELE DESVIA
        ...
        lw $18, 4($8)
        sb $17, 0($18)           #//COLOCA O ANTIGO PRIMEIRO ELEMENTO DA LISTA COMO PRÓXIMO DO NOVO PRIMEIRO
